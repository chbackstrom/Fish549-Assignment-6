...
\fancyhead[L]{Backstrom}
\fancyhead[R]{Assignment 6}
\fancyfoot[C]{\thepage}

```{r citations, include = FALSE, ECHO = FALSE}
library(knitcitations) # Loads the citation package
cleanbib() # clears out any cached references
options("citation_format" = "pandoc") # sets pandoc for formatting
citation("knitr")
```
...
write.bibtex(file = "references.bib") # create ref cited section
```
